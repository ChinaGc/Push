...
/**
 * 
 * @ClassName: PacketConnector
 * @Description: 实际连接socket IO操作 连接器
 * @author guocan
 * @date 2017-9-12 下午2:14:46
 * 
 */
public class PacketConnector {
    ...
    // 请求队列
    private LinkedBlockingQueue<Request> requestQueue = new LinkedBlockingQueue<Request>(128);
    ...
    public interface IOListener {
        void onOutputFailed(Request request, Exception e);
